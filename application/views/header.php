...
<head>
    ...
    <script type="text/javascript" src="<?=PUBLIC_URL?>js/bootstrap-datepicker.min.js?v=1.1"></script>
    ...
    <link rel="stylesheet" href="<?=PUBLIC_URL?>css/bootstrap-datepicker3.min.css?v=1.0">

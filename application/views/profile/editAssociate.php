...
<?php if($isAdmin) { ?>
                <fieldset class="form-control">
                    ...
                    <div class="form-group field">
                        <div class="row subField">
                            <label for="associate-type" class="col-md-2 col-form-label">Type</label>
                            <div class="col-md-10">
                                <input required class="form-control" type="text" name="associate-type" id="associate-type" value="<?=isset($data['associate']['type']) ? $data['associate']['type'] : ''?>"/>
                                <small id="associate-type-help" class="form-text text-muted">Mandatory</small>
                            </div>
                        </div>
                        <div class="row subField">
                            <label for="associate-yearelected" class="col-md-2 col-form-label">Year Elected</label>
                            <div class="col-md-10">
                                <input required pattern="\d{4}" class="form-control" type="text" name="associate-yearelected" id="associate-yearelected" value="<?=isset($data['associate']['yearelected']) ? $data['associate']['yearelected'] : ''?>"/>
                                <small id="associate-yearelected-help" class="form-text text-muted">Mandatory</small>
                            </div>
                        </div>
                    </div>
                </fieldset>
...
?>
                <input class="form-control" type="hidden" name="associate-<?=$key?>" id="associate-<?=$key?>" value="<?=$value?>" />
<?php } } }?>
